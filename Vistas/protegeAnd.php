  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="input-group input-group-sm col-6 float-letf mb-5">
          <input type="text" class="form-control" name="geodesico" id="geodesico" placeholder="Buscar punto geodesico">
...
function obtener_geo(geodesico)
{
	$.ajax({
		url : 'and.php',
		type : 'POST',
		dataType : 'html',
		data : { geodesico: geodesico },
		})
...
$(document).on('keyup', '#geodesico', function()
{
	var valorBusqueda=$(this).val();
	if (valorBusqueda!="")
	{
		obtener_geo(valorBusqueda);
	}
	else
		{
			obtener_geo();
